...
public class Login extends JFrame {
	...
	public Login() {
		...
		lblNewLabel_1.setIcon(new ImageIcon(Login.class.getResource("/imagenes/LogoP.png")));
		lblNewLabel_1.setBounds(135, 0, 188, 159);
		...
		separator.setBackground(SystemColor.darkGray);
		separator.setBounds(65, 292, 324, 5);
		panel.add(separator);
		
		JLabel labelTitulo = new JLabel("INICIAR SESIÓN");
		labelTitulo.setForeground(SystemColor.darkGray);
		labelTitulo.setFont(new Font("Roboto Black", Font.PLAIN, 26));
		labelTitulo.setBounds(125, 90, 198, 159);
		panel.add(labelTitulo);
		
		JSeparator separator_1 = new JSeparator();
		separator_1.setBackground(SystemColor.darkGray);
		separator_1.setBounds(65, 393, 324, 5);
		...
		btnLogin.setBackground(SystemColor.darkGray);
		btnLogin.setBounds(175, 431, 122, 44);
		panel.add(btnLogin);
